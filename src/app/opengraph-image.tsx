...
const emblem = `data:image/svg+xml;utf8,${encodeURIComponent(
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
    ...
    <circle cx="24" cy="24" r="18.8" fill="none" stroke="#06120d" stroke-opacity="0.22" stroke-width="1"/>
    <g fill="none" stroke="#06120d" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" stroke-opacity="0.92">
    ...
    (
      <div
        style={{
          ...
          background:
            "radial-gradient(900px 600px at 80% -10%, rgba(201,162,94,0.18), transparent 60%), linear-gradient(135deg, #0a1c14 0%, #0f2519 55%, #06120d 100%)",
          fontFamily: "serif",
          color: "#f4ecda",
        }}
      >
